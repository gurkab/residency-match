...
public class Application {
    public static void main(String[] args) {
        ...
        applicantsMap.put("Rachel", List.of("city", "mercy"));
        ...
        programsMap.put("city", new ProgramAttributes(2, List.of("Aaron", "Emily", "Dina", "Brian", "Rachel", "Alex", "Katherine", "Michael")));
        programsMap.put("general", new ProgramAttributes(2, List.of("Rachel", "Dina", "Emily", "Brian", "Alex", "Katherine", "Aaron")));
        programsMap.put("mercy", new ProgramAttributes(2, List.of("Alex", "Aaron")));
        programsMap.put("state", new ProgramAttributes(2, List.of("Rachel", "Dina", "Brian", "Alex", "Emily", "Michael", "Katherine", "Aaron")));
